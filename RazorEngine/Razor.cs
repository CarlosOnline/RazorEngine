namespace RazorEngine
{
    ...
    public static class Razor
    {
        ...
        /// <summary>
        /// True to keep temp files used by compiler.  Helpful for debugging
        /// </summary>
        public static bool KeepFiles
        {
            get { return RazorCompiler.KeepFiles; }
            set { RazorCompiler.KeepFiles = value; }
        }
        ...
        /// <param name="name">[Optional] A name for the template used for caching.</param>
        /// <returns>The parsed template.</returns>
        public static string ParseWithErrors<T>(string template, T model, string name = null)
        {
            try
            {
                var instance = GetTemplate(template, typeof(T), name);
